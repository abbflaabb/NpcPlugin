package com.Relxwe.npcPlugin.versions.v1_8_R3;
...
public class VersionHandlerImpl implements VersionHandler {
    ...
    public void spawnNPC(String id, String name, World world, Location location, String skinTexture) {
        try {
            ...
            Method getServerMethod = Class.forName("org.bukkit.craftbukkit.v1_8_R3.CraftServer").getMethod("getServer");
            ...
            Method getHandleMethod = Class.forName("org.bukkit.craftbukkit.v1_8_R3.CraftWorld").getMethod("getHandle");
            ...
            Class<?> playerInteractManagerClass = Class.forName("net.minecraft.server.v1_8_R3.PlayerInteractManager");
            ...
            Class<?> packetPlayOutPlayerInfoClass = Class.forName("net.minecraft.server.v1_8_R3.PacketPlayOutPlayerInfo");
            Class<?> enumPlayerInfoActionClass = Class.forName("net.minecraft.server.v1_8_R3.PacketPlayOutPlayerInfo$EnumPlayerInfoAction");
            Object addPlayerAction = enumPlayerInfoActionClass.getField("ADD_PLAYER").get(null);
            Constructor<?> packetPlayOutPlayerInfoConstructor = packetPlayOutPlayerInfoClass.getConstructor(enumPlayerInfoActionClass, Class.forName("net.minecraft.server.v1_8_R3.EntityPlayer"));
            Object packetPlayOutPlayerInfoAdd = packetPlayOutPlayerInfoConstructor.newInstance(addPlayerAction, npc);

            Class<?> packetPlayOutEntityTeleportClass = Class.forName("net.minecraft.server.v1_8_R3.PacketPlayOutEntityTeleport");
            Constructor<?> packetPlayOutEntityTeleportConstructor = packetPlayOutEntityTeleportClass.getConstructor(Class.forName("net.minecraft.server.v1_8_R3.Entity"));
            Object packetPlayOutEntityTeleport = packetPlayOutEntityTeleportConstructor.newInstance(npc);

            Class<?> packetPlayOutNamedEntitySpawnClass = Class.forName("net.minecraft.server.v1_8_R3.PacketPlayOutNamedEntitySpawn");
            Constructor<?> packetPlayOutNamedEntitySpawnConstructor = packetPlayOutNamedEntitySpawnClass.getConstructor(Class.forName("net.minecraft.server.v1_8_R3.EntityHuman"));
